 ...
 * 规则解析
 */
var processRule = function(options, rule, result, callback) {
    ...
    pro.then(function(data) {
        ...
        if((isAll && allthen) || options.then) {
            ...
            return processRule(options, rule, result, callback);
...
module.exports = function(rule, callback) {
    processRule(rule.start, rule, {}, callback);
}
